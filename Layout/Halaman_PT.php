...
<body>
    ...
    <section class="section-two">
        <div class="container-box">
            ...
            $sql = "SELECT id_user, nama, id_gym, email, pembayaran, req_date, keterangan FROM pt_mem LIMIT $limit OFFSET $offset";
            $result = $conn->query($sql);

            $total_data_query = "SELECT COUNT(*) as total FROM pt_mem";
            $total_data_result = $conn->query($total_data_query);
            $total_data = $total_data_result->fetch_assoc()['total'];
            $total_pages = ceil($total_data / $limit);

            echo "<table>";
            echo "<thead><tr><th>Nama</th><th>ID Gym</th><th>Email</th><th>Pembayaran</th><th>Tanggal Request</th><th>Keterangan</th></tr></thead>";
            echo "<tbody>";
